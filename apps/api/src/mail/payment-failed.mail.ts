...
export const PAYMENT_FAILED_SUBJECT =
  "[Eudify Academy] Acción requerida: actualiza tu pago";
...
export function buildPaymentFailedPlainText(
  ...
  return [
    ...
    "",
    "Por favor entra a Eudify Academy y actualiza tu método de pago para evitar retrasos con la sesión.",
    "",
        ...
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:520px;background:${c.card};border-radius:16px;border:1px solid ${c.border};overflow:hidden;box-shadow:0 4px 24px rgba(11,31,58,0.08);">
          ...
          <tr>
            <td style="padding:28px 28px 8px;">
              ...
              <p style="margin:0 0 16px;font-size:15px;line-height:1.65;color:${c.muted};font-family:system-ui,-apple-system,sans-serif;">No pudimos procesar el pago de tu cita confirmada. Actualiza tu método de pago desde Eudify Academy para evitar retrasos con la sesión.</p>
