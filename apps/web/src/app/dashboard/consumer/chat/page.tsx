...
export default function ConsumerChatPage() {
  return (
    <main className="mx-auto max-w-6xl space-y-4 px-4 py-6 sm:px-6">
      <Link href="/dashboard/consumer" className="text-sm font-semibold text-primary underline">
        ← Volver al panel familiar
      </Link>
      <h1 className="text-2xl font-bold text-primary">Chat con educadores</h1>
      <ChatInboxScreen />
    </main>
  );
}
